...
redirect_uri = _resolve("BLING_REDIRECT_URI", company, secrets)

if not client_id or not client_secret or not redirect_uri:
    raise SystemExit(f"Missing BLING_* for company {company} (env or secrets file)")
...
print(f"Tokens saved to {token_file} (company={company})")
